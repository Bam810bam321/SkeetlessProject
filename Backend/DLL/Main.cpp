...
void __stdcall MainThread(LPVOID lpParam)
{
	...
	LI_FN(Sleep).get()(500);
	Cheat::Utilities->Game_Msg((std::string(xorstr_("Welcome to ")) + Cheat::Settings->UserName).c_str());
	Cheat::Utilities->Game_Msg((std::string(xorstr_("Fixed by: ")) + Cheat::Settings->FixedBy).c_str());
